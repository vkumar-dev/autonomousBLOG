...
class ArticleViewer {
   ...
   * e.g., /autonomousBLOG/view-article.html?article=2026/02/26/my-article.html
   */
    ...
    const articleHtml = `
      <article class="article-page">
        <nav class="article-nav">
          <a href="index.html" class="nav-home"><span class="nav-icon">←</span><span class="nav-text">autonomousBLOG</span></a>
          <a href="index.html?view=list" class="nav-articles"><span class="nav-text">View All Articles</span><span class="nav-icon">📰</span></a>
        </nav>
        ...
        <main class="article-content">
          ...
          <footer class="article-footer">
            <p class="generated-info"><span class="bot-icon">🤖</span> This article was autonomously generated</p>
